...
const Cta = (props:Prop) => { 
    ...
    <a className="sm:mb-24 mb-16 lg:px-20 lg:py-4 md:px-10 md:py-3  px-9 py-2  rounded-[59px] text-color-fourth bg-cover lg:text-xl lg:font-bold md:text-md text-md font-medium"   href='tel:+1(347)-795-0173'style={{backgroundImage:'url("Button (2).png")' }}>+1(347)-795-0173</a>
    </div>
      </div>
    </section>
    );
